...
DOCUMENTATION = r"""
module: networks_switch_stacks_routing_staticRoutes
  ...
  vrf:
    ...
    suboptions:
      leakRouteToDefaultVrf:
        description: Whether or not next-hop IP is reachable via default VRF.
        type: bool
      name:
        description: The name of the VRF this static route belongs to.
        type: str
    type: dict
requirements:
  - meraki >= 2.4.9

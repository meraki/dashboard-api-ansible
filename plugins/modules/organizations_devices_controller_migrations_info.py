...
notes:
  - SDK Method used are
    organizations.Organizations.get_organization_devices_controller_migrations,
  - Paths used are
    get /organizations/{organizationId}/devices/controller/migrations,
"""

EXAMPLES = r"""
- name: Get all organizations _devices _controller _migrations
  cisco.meraki.organizations_devices_controller_migrations_info:

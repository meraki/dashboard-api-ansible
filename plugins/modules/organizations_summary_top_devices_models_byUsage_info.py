...
DOCUMENTATION = r"""
module: organizations_summary_top_devices_models_byUsage_info
short_description: Information module for organizations _summary _top _devices _models
  _byusage
description:
  - Information module for Organizations Summary Top Devices Models Byusage Info.
  - Get all organizations _summary _top _devices _models _byusage.
  - >
    Return metrics for organization's top 10 device models sorted by data usage over

...
options:
  ...
  name:
    description:
    - >
      Name query parameter. Optional parameter to filter RF profiles by device name. All returned devices will
      have a name that contains the search term or is an exact match.
    type: str
  mac:
    description:
    - >
      Mac query parameter. Optional parameter to filter RF profiles by device MAC address. All returned devices
      will have a MAC address that contains the search term or is an exact match.
    type: str
  serial:
    description:
    - >
      Serial query parameter. Optional parameter to filter RF profiles by device serial number. All returned
      devices will have a serial number that contains the search term or is an exact match.
    type: str
  model:
    description:
    - >
      Model query parameter. Optional parameter to filter RF profiles by device model. All returned devices will
      have a model that contains the search term or is an exact match.
    type: str
  macs:
    description:
    - >
      Macs query parameter. Optional parameter to filter RF profiles by one or more device MAC addresses. All
  ...
  serials:
    description:
    - >
      Serials query parameter. Optional parameter to filter RF profiles by one or more device serial numbers. All
  ...
  models:
    description:
    - >
      Models query parameter. Optional parameter to filter RF profiles by one or more device models. All returned
      devices will have a model that is an exact match.
    elements: str
    type: list
requirements:
  - meraki >= 2.4.9
...
notes:
  - SDK Method used are
    wireless.Wireless.get_organization_wireless_rf_profiles_assignments_by_device,
...
EXAMPLES = r"""
- name: Get all organizations _wireless _rf _profiles _assignments _by _device
  cisco.meraki.organizations_wireless_rf_profiles_assignments_by_device_info:

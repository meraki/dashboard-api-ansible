...
DOCUMENTATION = r"""
module: organizations_splash_themes_assets
short_description: Resource module for organizations _splash _themes _assets
description:
  - Manage operation create of the resource organizations _splash _themes _assets.
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.organizations_splash_themes_assets:

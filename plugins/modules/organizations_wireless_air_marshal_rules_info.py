...
notes:
  - SDK Method used are wireless.Wireless.get_organization_wireless_air_marshal_rules,
  - Paths used are get /organizations/{organizationId}/wireless/airMarshal/rules,
options:
  endingBefore:
    description:

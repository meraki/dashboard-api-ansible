...
options:
  ...
  serials:
    description:
    - >
      Serials query parameter. Optional parameter to filter access points by its cloud ID. This filter uses
      multiple exact matches.
    elements: str
    type: list
  controllerSerials:
    description:
    - >
      ControllerSerials query parameter. Optional parameter to filter access points by its wireless LAN controller

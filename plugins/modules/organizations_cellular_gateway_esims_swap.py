...
description:
  - Manage operations create and update of the resource organizations _cellular _gateway
    _esims _swap.
...
options:
  id:
    description: Id path parameter. ESIM EID.
    type: str
  organizationId:
  ...
  swaps:
    ...
    suboptions:
      ...
      target:
        ...
        suboptions:
          accountId:
            description: ID of the target account; can be the account currently tied
              to the eSIM.
            type: str
          communicationPlan:
...
seealso:
  ...
  - name: Cisco Meraki documentation for cellularGateway updateOrganizationCellularGatewayEsimsSwap
    description: Complete reference of the updateOrganizationCellularGatewayEsimsSwap
      API.
    link: https://developer.cisco.com/meraki/api-v1/#!update-organization-cellular-gateway-esims-swap
notes:
  - SDK Method used are
    cellular_gateway.CellularGateway.create_organization_cellular_gateway_esims_swap,
    cellular_gateway.CellularGateway.update_organization_cellular_gateway_esims_swap,
  - Paths used are

...
notes:
  - SDK Method used are
    switch.Switch.get_organization_switch_ports_usage_history_by_device_by_interval,
  - Paths used are
    get /organizations/{organizationId}/switch/ports/usage/history/byDevice/byInterval,
"""

EXAMPLES = r"""
- name: Get all organizations _switch _ports _usage _history _by _device _by _interval
  cisco.meraki.organizations_switch_ports_usage_history_by_device_by_interval_info:

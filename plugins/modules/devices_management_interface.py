...
description:
  - Manage operations update of the resource devices _management _interface.
  - Update the management interface settings for a device.
  - A device's management interface always exists, so C(state=present) always
    updates it; there is no create operation for this resource.
version_added: '1.0.0'

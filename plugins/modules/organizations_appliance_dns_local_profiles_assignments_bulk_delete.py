...
notes:
  - SDK Method used are
    appliance.Appliance.create_organization_appliance_dns_local_profiles_assignments_bulk_delete,
  - Paths used are
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.organizations_appliance_dns_local_profiles_assignments_bulk_delete:

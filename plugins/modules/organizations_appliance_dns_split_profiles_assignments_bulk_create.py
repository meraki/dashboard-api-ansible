...
notes:
  - SDK Method used are
    appliance.Appliance.create_organization_appliance_dns_split_profiles_assignments_bulk_create,
  - Paths used are
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.organizations_appliance_dns_split_profiles_assignments_bulk_create:

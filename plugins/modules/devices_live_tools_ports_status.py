...
DOCUMENTATION = r"""
module: devices_live_tools_ports_status
short_description: Resource module for devices _live _tools _ports _status
description:
  - Manage operation create of the resource devices _live _tools _ports _status. -
    > Enqueue a job to retrieve port status for a device. This endpoint has a sustained
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco Meraki documentation for devices createDeviceLiveToolsPortsStatus
    description: Complete reference of the createDeviceLiveToolsPortsStatus API.
    link: https://developer.cisco.com/meraki/api-v1/#!create-device-live-tools-ports-status
notes:
  - SDK Method used are
    devices.Devices.create_device_live_tools_ports_status,
  - Paths used are
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.devices_live_tools_ports_status:

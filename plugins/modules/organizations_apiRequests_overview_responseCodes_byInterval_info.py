...
DOCUMENTATION = r"""
module: organizations_apiRequests_overview_responseCodes_byInterval_info
short_description: Information module for organizations _apirequests _overview _responsecodes
  _byinterval
description:
  - Information module for Organizations Apirequests Overview Responsecodes Byinterval Info.

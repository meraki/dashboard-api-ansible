...
notes:
  - SDK Method used are wireless_controller.WirelessController.get_organization_wireless_controller_devices_system_utilization_history_by_interval,
  - Paths used are get /organizations/{organizationId}/wirelessController/devices/system/utilization/history/byInterval,
options:
  endingBefore:
    description:

...
DOCUMENTATION = r"""
module: organizations_wireless_devices_radsec_certificates_authorities_crls_info
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco Meraki documentation for wireless getOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrls
    description: Complete reference of the getOrganizationWirelessDevicesRadsecCertificatesAuthoritiesCrls
      API.
    link: https://developer.cisco.com/meraki/api-v1/#!get-organization-wireless-devices-radsec-certificates-authorities-crls
notes:
  - SDK Method used are
    wireless.Wireless.get_organization_wireless_devices_radsec_certificates_authorities_crls,
  - Paths used are
...
- name: Get all organizations _wireless _devices _radsec _certificates _authorities
    _crls
  cisco.meraki.organizations_wireless_devices_radsec_certificates_authorities_crls_info:

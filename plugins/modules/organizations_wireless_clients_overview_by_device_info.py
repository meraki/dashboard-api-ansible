...
options:
  ...
  networkIds:
    description:
    - >
      NetworkIds query parameter. Optional parameter to filter access points client counts by network ID. This
  ...
  serials:
    description:
    - >
      Serials query parameter. Optional parameter to filter access points client counts by its serial numbers.
  ...
  campusGatewayClusterIds:
    description:
    - >
      CampusGatewayClusterIds query parameter. Optional parameter to filter access points client counts by MCG

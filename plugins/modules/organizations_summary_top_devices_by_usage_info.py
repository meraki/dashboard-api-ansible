...
short_description: Information module for organizations _summary _top _devices _by
  _usage
description:
  - Get all organizations _summary _top _devices _by _usage. - > Return metrics for
    organization's top 10 devices sorted by data usage over given time range. Default
    unit is megabytes.
version_added: '1.0.0'

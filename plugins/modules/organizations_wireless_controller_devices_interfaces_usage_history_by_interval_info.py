...
description:
  - Get all organizations _wireless _controller _devices _interfaces _usage _history
    _by _interval.
...
notes:
  - SDK Method used are wireless_controller.WirelessController.get_organization_wireless_controller_devices_interfaces_usage_history_by_interval,
  - Paths used are get /organizations/{organizationId}/wirelessController/devices/interfaces/usage/history/byInterval,
options:
  endingBefore:
    description:
...
requirements:
  ...
  - python >= 3.5
seealso:
  - description: Complete reference of the getOrganizationWirelessControllerDevicesInterfacesUsageHistoryByInterval
      API.
...
short_description: Information module for organizations _wireless _controller _devices
  _interfaces _usage _history _by _interval
version_added: 2.20.0
"""

EXAMPLES = r"""
- name: Get all organizations _wireless _controller _devices _interfaces _usage _history _by _interval
  cisco.meraki.organizations_wireless_controller_devices_interfaces_usage_history_by_interval_info:

...
short_description: Information module for organizations _wireless _air _marshal _settings
  _by _network
description:
  - Information module for Organizations Wireless Air Marshal Settings By Network Info.
...
EXAMPLES = r"""
- name: Get all organizations _wireless _air _marshal _settings _by _network
  cisco.meraki.organizations_wireless_air_marshal_settings_by_network_info:

...
options:
  ...
  - Information module for Organizations Devices System Memory Usage History By Interval Info.
      - >
        ...
        be in seconds and be less than or equal to 31 days. The default is 2 hours.
...
seealso:
  - name: Cisco Meraki documentation for organizations getOrganizationDevicesSystemMemoryUsageHistoryByInterval
    description: Complete reference of the getOrganizationDevicesSystemMemoryUsageHistoryByInterval
      API.

...
DOCUMENTATION = r"""
module: devices_live_tools_mac_table
short_description: Resource module for devices _live _tools _mac _table
description:
  - Manage operation create of the resource devices _live _tools _mac _table.
  - >
    Enqueue a job to request the MAC table from the device. Switches currently support
    this feature. This endpoint has a sustained rate limit of one request every five
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco Meraki documentation for devices createDeviceLiveToolsMacTable
    description: Complete reference of the createDeviceLiveToolsMacTable API.
    link: https://developer.cisco.com/meraki/api-v1/#!create-device-live-tools-mac-table
notes:
  - SDK Method used are
    devices.Devices.create_device_live_tools_mac_table,
  - Paths used are
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.devices_live_tools_mac_table:

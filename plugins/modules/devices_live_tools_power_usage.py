...
DOCUMENTATION = r"""
module: devices_live_tools_power_usage
short_description: Resource module for devices _live _tools _power _usage
description:
  - Manage operation create of the resource devices _live _tools _power _usage. -
    > Enqueues a live tool job that retrieves details about a device's overall power
    usage. This endpoint has a sustained rate limit of one request every five seconds
    per device, with an allowed burst of five requests.
version_added: '1.0.0'
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco Meraki documentation for devices createDeviceLiveToolsPowerUsage
    description: Complete reference of the createDeviceLiveToolsPowerUsage API.
    link: https://developer.cisco.com/meraki/api-v1/#!create-device-live-tools-power-usage
notes:
  - SDK Method used are
    devices.Devices.create_device_live_tools_power_usage,
  - Paths used are
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.devices_live_tools_power_usage:

...
options:
  ...
  profile:
    ...
    type: dict
  recordId:
    description: RecordId path parameter. Record ID.
    type: str
requirements:
  - meraki >= 2.4.9
  - python >= 3.5
seealso:
  - name: Cisco Meraki documentation for appliance createOrganizationApplianceDnsLocalRecord
    description: Complete reference of the createOrganizationApplianceDnsLocalRecord
      API.
    link: https://developer.cisco.com/meraki/api-v1/#!create-organization-appliance-dns-local-record
  - name: Cisco Meraki documentation for appliance deleteOrganizationApplianceDnsLocalRecord
    description: Complete reference of the deleteOrganizationApplianceDnsLocalRecord
      API.
    link: https://developer.cisco.com/meraki/api-v1/#!delete-organization-appliance-dns-local-record
  - name: Cisco Meraki documentation for appliance updateOrganizationApplianceDnsLocalRecord
    description: Complete reference of the updateOrganizationApplianceDnsLocalRecord
      API.
    link: https://developer.cisco.com/meraki/api-v1/#!update-organization-appliance-dns-local-record
notes:
  - SDK Method used are
    appliance.Appliance.create_organization_appliance_dns_local_record,
    appliance.Appliance.delete_organization_appliance_dns_local_record,
    appliance.Appliance.update_organization_appliance_dns_local_record,
  - Paths used are

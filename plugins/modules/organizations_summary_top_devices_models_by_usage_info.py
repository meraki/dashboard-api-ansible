...
short_description: Information module for organizations _summary _top _devices _models
  _by _usage
description:
  - Get all organizations _summary _top _devices _models _by _usage. - > Return metrics
    for organization's top 10 device models sorted by data usage over given time range.

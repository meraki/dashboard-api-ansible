...
description:
  ...
  - 'Return metrics for organization''s top 10 device models sorted by data usage
    over given time range. Default unit is megabytes.
  ...
  timespan:
    description:
      - 'Timespan query parameter. The timespan for which the information will be
        ...
        value must be in seconds and be greater than or equal to 8 hours and be less
        than or equal to 186 days. The default is 1 day.
...
requirements:
  ...
  - python >= 3.5
seealso:
  - description: Complete reference of the getOrganizationSummaryTopDevicesModelsByUsage
      API.
...
short_description: Information module for organizations _summary _top _devices _models
  _by _usage

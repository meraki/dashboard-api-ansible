  ...
  networks:
    ...
    suboptions:
      networkId:
        ...
        type: str
      productTypes:
        description: List of products for which to disable XDR.
        elements: str
        type: list
    type: list
  organizationId:
...
notes:
  - SDK Method used are
    organizations.Organizations.disable_organization_integrations_xdr_networks,
  - Paths used are
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.organizations_integrations_xdr_networks_disable:

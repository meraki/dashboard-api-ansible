...
notes:
  - SDK Method used are switch.Switch.get_organization_switch_ports_statuses_by_switch,
  - Paths used are get /organizations/{organizationId}/switch/ports/statuses/bySwitch,
options:
...
requirements:
  ...
  - python >= 3.5
seealso:
  - description: Complete reference of the getOrganizationSwitchPortsStatusesBySwitch
      API.
...
short_description: Information module for organizations _switch _ports _statuses _by
  _switch

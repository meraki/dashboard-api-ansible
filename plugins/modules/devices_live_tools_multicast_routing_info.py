...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco Meraki documentation for devices getDeviceLiveToolsMulticastRouting
    description: Complete reference of the getDeviceLiveToolsMulticastRouting API.
    link: https://developer.cisco.com/meraki/api-v1/#!get-device-live-tools-multicast-routing
notes:
  - SDK Method used are
    devices.Devices.get_device_live_tools_multicast_routing,
  - Paths used are
    get /devices/{serial}/liveTools/multicastRouting/{multicastRoutingId},
"""

EXAMPLES = r"""
- name: Get devices _live _tools _multicast _routing by id
  cisco.meraki.devices_live_tools_multicast_routing_info:

...
description:
  - Get all organizations _wireless _devices _channel _utilization _history _by _network
    _by _interval.
...
notes:
  - SDK Method used are wireless.Wireless.get_organization_wireless_devices_channel_utilization_history_by_network_by_interval,
  - Paths used are get /organizations/{organizationId}/wireless/devices/channelUtilization/history/byNetwork/byInterval,
options:
  endingBefore:
    description:
...
requirements:
  ...
  - python >= 3.5
seealso:
  - description: Complete reference of the getOrganizationWirelessDevicesChannelUtilizationHistoryByNetworkByInterval
      API.
...
short_description: Information module for organizations _wireless _devices _channel
  _utilization _history _by _network _by _interval
version_added: 2.16.0
"""

EXAMPLES = r"""
- name: Get all organizations _wireless _devices _channel _utilization _history _by
    _network _by _interval

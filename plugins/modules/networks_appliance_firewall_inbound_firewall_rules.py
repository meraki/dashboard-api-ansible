...
description:
  - Manage operation update of the resource networks _appliance _firewall _inbound
    _firewall _rules.
...
requirements:
  ...
  - python >= 3.5
seealso:
  - description: Complete reference of the updateNetworkApplianceFirewallInboundFirewallRules
      API.
...
short_description: Resource module for networks _appliance _firewall _inbound _firewall
  _rules

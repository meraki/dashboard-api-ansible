...
DOCUMENTATION = r"""
module: devices_liveTools_pingDevice
...
description:
  ...
  - >
    Enqueue a job to check connectivity status to the device. This endpoint has a
    sustained rate limit of one request every five seconds per device, with an allowed

...
DOCUMENTATION = r"""
module: organizations_wireless_devices_packetLoss_byDevice_info
short_description: Information module for organizations _wireless _devices _packetloss
  _bydevice
description:
  - Information module for Organizations Wireless Devices Packetloss Bydevice Info.
  ...
  - >
    ...
    Does not include device's own traffic.
version_added: '1.0.0'
  ...
  timespan:
    description:
      ...
      - >
        ...
        be in seconds and be greater than or equal to 5 minutes and be less than or
...
seealso:
  - name: Cisco Meraki documentation for wireless getOrganizationWirelessDevicesPacketLossByDevice
    description: Complete reference of the getOrganizationWirelessDevicesPacketLossByDevice
      API.

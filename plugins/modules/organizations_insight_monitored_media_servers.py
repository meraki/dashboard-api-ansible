...
description:
  - Manage operations create, update and delete of the resource organizations _insight
    _monitored _media _servers.
  - Add a media server to be monitored for this organization. Only valid for organizations
    with Meraki Insight.
  - Delete a monitored media server from this organization. Only valid for organizations
    with Meraki Insight.
  - Update a monitored media server for this organization. Only valid for organizations
    with Meraki Insight.
...
notes:
  - SDK Method used are insight.Insight.create_organization_insight_monitored_media_server,
    insight.Insight.delete_organization_insight_monitored_media_server, insight.Insight.update_organization_insight_monitored_media_server,
  - Paths used are post /organizations/{organizationId}/insight/monitoredMediaServers,
...
options:
  ...
  bestEffortMonitoringEnabled:
    description: Indicates that if the media server doesn't respond to ICMP pings,
      the nearest hop will be used in its stead.
    type: bool
...
requirements:
  ...
  - python >= 3.5
seealso:
  - description: Complete reference of the createOrganizationInsightMonitoredMediaServer
      API.
  ...
  - description: Complete reference of the deleteOrganizationInsightMonitoredMediaServer
      API.
  ...
  - description: Complete reference of the updateOrganizationInsightMonitoredMediaServer
      API.

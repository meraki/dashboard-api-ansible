...
short_description: Information module for organizations _sase _networks _eligible
description:
  - Get all organizations _sase _networks _eligible.
...
options:
  ...
  search:
    description:
      - Search query parameter. If provided, filters results by network name.
    type: str
requirements:
  - meraki >= 2.4.9
  - python >= 3.5
seealso:
  - name: Cisco Meraki documentation for organizations getOrganizationSaseNetworksEligible
    description: Complete reference of the getOrganizationSaseNetworksEligible API.
    link: https://developer.cisco.com/meraki/api-v1/#!get-organization-sase-networks-eligible
notes:
  - SDK Method used are
...
EXAMPLES = r"""
- name: Get all organizations _sase _networks _eligible
  cisco.meraki.organizations_sase_networks_eligible_info:

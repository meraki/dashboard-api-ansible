...
DOCUMENTATION = r"""
module: devices_live_tools_routing_table_summaries
short_description: Resource module for devices _live _tools _routing _table _summaries
description:
  - Manage operation create of the resource devices _live _tools _routing _table _summaries.
    - > Enqueue a routing table summary job for a device. The job fetches summary
    data such as route counts by VRF and protocol. Only Cisco Secure Routers are supported.
version_added: '1.0.0'
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco Meraki documentation for devices createDeviceLiveToolsRoutingTableSummary
    description: Complete reference of the createDeviceLiveToolsRoutingTableSummary
      API.
    link: https://developer.cisco.com/meraki/api-v1/#!create-device-live-tools-routing-table-summary
notes:
  - SDK Method used are
    devices.Devices.create_device_live_tools_routing_table_summary,
  - Paths used are
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.devices_live_tools_routing_table_summaries:

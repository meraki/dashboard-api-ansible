...
description:
  - Get all organizations _wireless _controller _devices _interfaces _packets _overview
    _by _device.
...
notes:
  - SDK Method used are wireless_controller.WirelessController.get_organization_wireless_controller_devices_interfaces_packets_overview_by_device,
  - Paths used are get /organizations/{organizationId}/wirelessController/devices/interfaces/packets/overview/byDevice,
options:
  endingBefore:
    description:
  ...
  timespan:
    description:
      - 'Timespan query parameter. The timespan for which the information will be
        ...
        value must be in seconds and be less than or equal to 1 day. The default is
        1 hour.
...
requirements:
  ...
  - python >= 3.5
seealso:
  - description: Complete reference of the getOrganizationWirelessControllerDevicesInterfacesPacketsOverviewByDevice
      API.
...
short_description: Information module for organizations _wireless _controller _devices
  _interfaces _packets _overview _by _device
version_added: 2.20.0
"""

EXAMPLES = r"""
- name: Get all organizations _wireless _controller _devices _interfaces _packets
    _overview _by _device

...
DOCUMENTATION = r"""
module: devices_live_tools_ports_cycle
short_description: Resource module for devices _live _tools _ports _cycle
description:
  - Manage operation create of the resource devices _live _tools _ports _cycle. -
...
options:
  callback:
    ...
    type: dict
  ports:
    description: A list of ports to cycle. For Catalyst switches, IOS interface names
      are also supported, such as "GigabitEthernet1/0/8", "Gi1/0/8", or even "1/0/8".
    elements: str
    type: list
  serial:
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco Meraki documentation for devices createDeviceLiveToolsPortsCycle
    description: Complete reference of the createDeviceLiveToolsPortsCycle API.
    link: https://developer.cisco.com/meraki/api-v1/#!create-device-live-tools-ports-cycle
notes:
  - SDK Method used are
    devices.Devices.create_device_live_tools_ports_cycle,
  - Paths used are
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.devices_live_tools_ports_cycle:

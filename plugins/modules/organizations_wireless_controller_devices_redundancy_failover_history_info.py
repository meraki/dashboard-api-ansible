...
notes:
  - SDK Method used are wireless_controller.WirelessController.get_organization_wireless_controller_devices_redundancy_failover_history,
  - Paths used are get /organizations/{organizationId}/wirelessController/devices/redundancy/failover/history,
options:
  endingBefore:
    description:
...
requirements:
  ...
  - python >= 3.5
seealso:
  - description: Complete reference of the getOrganizationWirelessControllerDevicesRedundancyFailoverHistory
      API.
...
EXAMPLES = r"""
- name: Get all organizations _wireless _controller _devices _redundancy _failover
    _history

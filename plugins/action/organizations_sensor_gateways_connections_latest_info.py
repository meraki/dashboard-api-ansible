...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("sensorSerials") is not None:
            new_object["sensorSerials"] = params.get(
                "sensorSerials")
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            family="sensor",
            function='getOrganizationSensorGatewaysConnectionsLatest',

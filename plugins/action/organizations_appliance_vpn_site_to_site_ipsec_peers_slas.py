...
class OrganizationsApplianceVpnSiteToSiteIpsecPeersSlas(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="appliance",
                function="getOrganizationApplianceVpnSiteToSiteIpsecPeersSlas",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="appliance",
            function="updateOrganizationApplianceVpnSiteToSiteIpsecPeersSlas",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsApplianceVpnSiteToSiteIpsecPeersSlas(

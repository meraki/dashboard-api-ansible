...
argument_spec.update(dict(
    ...
    assignmentIds=dict(type="list"),
    policyIds=dict(type="list"),
    adaptivePolicyGroupIds=dict(type="list"),
...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("assignmentIds") is not None:
            new_object["assignmentIds"] = params.get(
                "assignmentIds")
        if params.get("policyIds") is not None:
            new_object["policyIds"] = params.get(
                "policyIds")
        if params.get("adaptivePolicyGroupIds") is not None:
            new_object["adaptivePolicyGroupIds"] = params.get(
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            ...
            function='getOrganizationPoliciesGlobalGroupPoliciesAdaptivePolicyGroupsAssignments',
            params=self.get_all(
                self._task.args),
        )

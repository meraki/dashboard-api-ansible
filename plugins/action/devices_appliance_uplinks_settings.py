...
class DevicesApplianceUplinksSettings(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        if self.new_object.get('interfaces') is not None or self.new_object.get(
                'interfaces') is not None:
            new_object_params['interfaces'] = self.new_object.get(
                'interfaces') or self.new_object.get('interfaces')
        if self.new_object.get('serial') is not None or self.new_object.get(
                'serial') is not None:

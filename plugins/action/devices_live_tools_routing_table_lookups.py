...
class DevicesLiveToolsRoutingTableLookups(object):
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(
            type=params.get("type"),
            destination=params.get("destination"),
            nextHop=params.get("nextHop"),
            vpn=params.get("vpn"),
    ...
    def create_params(self):
        ...
        if self.new_object.get('nextHop') is not None or self.new_object.get(
                'next_hop') is not None:
            new_object_params['nextHop'] = self.new_object.get('nextHop') or \
                self.new_object.get('next_hop')
        if self.new_object.get(
                'vpn') is not None or self.new_object.get('vpn') is not None:
            new_object_params['vpn'] = self.new_object.get('vpn') or \
                self.new_object.get('vpn')
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="devices",
                function="getDeviceLiveToolsRoutingTableLookup",
                params={"id": id}
            )
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="devices",
            function="createDeviceLiveToolsRoutingTableLookup",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DevicesLiveToolsRoutingTableLookups(self._task.args, meraki)

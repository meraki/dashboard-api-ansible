...
class OrganizationsApplianceRoutingVrfsSettings(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="appliance",
                function="getOrganizationApplianceRoutingVrfsSettings",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="appliance",
            function="updateOrganizationApplianceRoutingVrfsSettings",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsApplianceRoutingVrfsSettings(

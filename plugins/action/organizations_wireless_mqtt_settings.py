...
class OrganizationsWirelessMqttSettings(object):
    ...
    def update_all_params(self):
        ...
        if self.new_object.get('mqtt') is not None or self.new_object.get(
                'mqtt') is not None:
            new_object_params['mqtt'] = self.new_object.get('mqtt') or \
                self.new_object.get('mqtt')
        if self.new_object.get(
                'ble') is not None or self.new_object.get('ble') is not None:
            new_object_params['ble'] = self.new_object.get('ble') or \
                self.new_object.get('ble')
        if self.new_object.get('wifi') is not None or self.new_object.get(
                'wifi') is not None:
            new_object_params['wifi'] = self.new_object.get('wifi') or \
                self.new_object.get('wifi')
        if self.new_object.get('organizationId') is not None or self.new_object.get(
                'organization_id') is not None:
            new_object_params['organizationId'] = self.new_object.get(
                'organizationId') or self.new_object.get('organization_id')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="wireless",
                function="getOrganizationWirelessMqttSettings",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="wireless",
            function="updateOrganizationWirelessMqttSettings",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsWirelessMqttSettings(self._task.args, meraki)

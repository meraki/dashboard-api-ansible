...
argument_spec.update(dict(
    ...
    includeAssigned=dict(type="bool"),
    includedSerials=dict(type="list"),
    excludedSerials=dict(type="list"),
    includedProfileIds=dict(type="list"),
    excludedProfileIds=dict(type="list"),
    deviceTypes=dict(type="list"),
    slots=dict(type="list"),
    name=dict(type="str"),
...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("includeAssigned") is not None:
            new_object["includeAssigned"] = params.get(
                "includeAssigned")
        if params.get("includedSerials") is not None:
            new_object["includedSerials"] = params.get(
                "includedSerials")
        if params.get("excludedSerials") is not None:
            new_object["excludedSerials"] = params.get(
                "excludedSerials")
        if params.get("includedProfileIds") is not None:
            new_object["includedProfileIds"] = params.get(
                "includedProfileIds")
        if params.get("excludedProfileIds") is not None:
            new_object["excludedProfileIds"] = params.get(
                "excludedProfileIds")
        if params.get("deviceTypes") is not None:
            new_object["deviceTypes"] = params.get(
                "deviceTypes")
        if params.get("slots") is not None:
            new_object["slots"] = params.get(
                "slots")
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            ...
            function='getOrganizationDevicesCellularDataDevices',

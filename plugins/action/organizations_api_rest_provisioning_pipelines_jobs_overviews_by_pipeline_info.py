...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("pipelineIds") is not None:
            new_object["pipelineIds"] = params.get(
                "pipelineIds")
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            ...
            function='getOrganizationApiRestProvisioningPipelinesJobsOverviewsByPipeline',
            params=self.get_all(
                self._task.args),
        )

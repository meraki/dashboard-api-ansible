...
class NetworksSwitchDscpToCosMappings(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        if self.new_object.get('mappings') is not None or self.new_object.get(
                'mappings') is not None:
            new_object_params['mappings'] = self.new_object.get(
                'mappings') or self.new_object.get('mappings')
        if self.new_object.get('networkId') is not None or self.new_object.get(
                'network_id') is not None:
            new_object_params['networkId'] = self.new_object.get(
                'networkId') or self.new_object.get('network_id')

...
required_if = [
    ("state", "present", ["interfaceId", "networkId"], True),
    ("state", "absent", ["interfaceId", "networkId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class NetworksApplianceInterfacesL3(object):
    ...
    def create_params(self):
        new_object_params = {}
        if self.new_object.get('port') is not None or self.new_object.get(
                'port') is not None:
            new_object_params['port'] = self.new_object.get('port') or \
                self.new_object.get('port')
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="appliance",
            function="createNetworkApplianceInterfacesL3",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="appliance",
            function="updateNetworkApplianceInterfacesL3",
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="appliance",
            function="deleteNetworkApplianceInterfacesL3",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksApplianceInterfacesL3(self._task.args, meraki)

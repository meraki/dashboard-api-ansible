...
argument_spec.update(dict(
    ...
    doorLockId=dict(type="str"),
))

required_if = [
    ("state", "present", ["doorLockId", "name", "organizationId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class OrganizationsWirelessZigbeeDoorLocks(object):
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(
            name=params.get("name"),
            organization_id=params.get("organizationId"),
            door_lock_id=params.get("doorLockId"),
        )
    ...
    def update_by_id_params(self):
        ...
        if self.new_object.get('organizationId') is not None or self.new_object.get(
            ...
            new_object_params['organizationId'] = self.new_object.get(
                'organizationId') or self.new_object.get('organization_id')
        if self.new_object.get('doorLockId') is not None or self.new_object.get(
                'door_lock_id') is not None:
            new_object_params['doorLockId'] = self.new_object.get(
                'doorLockId') or self.new_object.get('door_lock_id')
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="wireless",
                function="getOrganizationWirelessZigbeeDoorLocks",
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "door_lock_id") or self.new_object.get("doorLockId")
        ...
        if name_exists:
            _id = prev_obj.get("id")
            _id = _id or prev_obj.get("doorLockId")
            if id_exists and name_exists and o_id != _id:
                raise InconsistentParameters(
                    "The 'id' and 'name' params don't refer to the same object")
            if _id:
                self.new_object.update(dict(id=_id))
                self.new_object.update(dict(doorLockId=_id))
    ...
    def update(self):
        ...
        id = id or self.new_object.get("doorLockId")
        name = self.new_object.get("name")
        result = None
        if not id:
            ...
            if prev_obj_name:
                ...
                id_ = id_ or prev_obj_name.get("doorLockId")
            if id_:
                self.new_object.update(dict(doorlockid=id_))
        result = self.meraki.exec_meraki(
            family="wireless",
            function="updateOrganizationWirelessZigbeeDoorLock",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsWirelessZigbeeDoorLocks(self._task.args, meraki)

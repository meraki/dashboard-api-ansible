...
class DevicesSwitchPorts(object):
    def __init__(self, params, meraki):
        ...
        self.new_object = dict(
            ...
            stpPortFastTrunk=params.get("stpPortFastTrunk"),
            ...
            macWhitelistLimit=params.get("macWhitelistLimit"),
    ...
    def update_by_id_params(self):
        ...
        if self.new_object.get('poeEnabled') is not None or self.new_object.get(
                'poe_enabled') is not None:
        ...
        if self.new_object.get('voiceVlan') is not None or self.new_object.get(
                'voice_vlan') is not None:
            new_object_params['voiceVlan'] = self.new_object.get(
                'voiceVlan') or self.new_object.get('voice_vlan')
        ...
        if self.new_object.get('isolationEnabled') is not None or self.new_object.get(
                'isolation_enabled') is not None:
            new_object_params['isolationEnabled'] = self.new_object.get(
                'isolationEnabled')
        if self.new_object.get('rstpEnabled') is not None or self.new_object.get(
                'rstp_enabled') is not None:
            new_object_params['rstpEnabled'] = self.new_object.get(
                'rstpEnabled')
        if self.new_object.get('stpGuard') is not None or self.new_object.get(
                'stp_guard') is not None:
            new_object_params['stpGuard'] = self.new_object.get(
                'stpGuard') or self.new_object.get('stp_guard')
        if self.new_object.get('stpPortFastTrunk') is not None or self.new_object.get(
                'stp_port_fast_trunk') is not None:
            new_object_params['stpPortFastTrunk'] = self.new_object.get(
                'stpPortFastTrunk')
        if self.new_object.get('linkNegotiation') is not None or self.new_object.get(
                'link_negotiation') is not None:
            new_object_params['linkNegotiation'] = self.new_object.get(
                'linkNegotiation') or self.new_object.get('link_negotiation')
        ...
        if self.new_object.get('udld') is not None or self.new_object.get(
                'udld') is not None:
        ...
        if self.new_object.get('macAllowList') is not None or self.new_object.get(
                'mac_allow_list') is not None:
            new_object_params['macAllowList'] = self.new_object.get(
                'macAllowList') or self.new_object.get('mac_allow_list')
        if self.new_object.get('macWhitelistLimit') is not None or self.new_object.get(
                'mac_whitelist_limit') is not None:
            new_object_params['macWhitelistLimit'] = self.new_object.get(
                'macWhitelistLimit') or self.new_object.get('mac_whitelist_limit')
        if self.new_object.get('stickyMacAllowList') is not None or self.new_object.get(
                'sticky_mac_allow_list') is not None:
            new_object_params['stickyMacAllowList'] = self.new_object.get(
                'stickyMacAllowList') or self.new_object.get('sticky_mac_allow_list')
        if self.new_object.get('stickyMacAllowListLimit') is not None or self.new_object.get(
                'sticky_mac_allow_list_limit') is not None:
            new_object_params['stickyMacAllowListLimit'] = self.new_object.get(
                'stickyMacAllowListLimit') or self.new_object.get('sticky_mac_allow_list_limit')
        if self.new_object.get('stormControlEnabled') is not None or self.new_object.get(
                'storm_control_enabled') is not None:
        ...
        if self.new_object.get('peerSgtCapable') is not None or self.new_object.get(
                'peer_sgt_capable') is not None:
            new_object_params['peerSgtCapable'] = self.new_object.get(
                'peerSgtCapable')
        if self.new_object.get('flexibleStackingEnabled') is not None or self.new_object.get(
                'flexible_stacking_enabled') is not None:
            new_object_params['flexibleStackingEnabled'] = self.new_object.get(
                'flexibleStackingEnabled')
        if self.new_object.get('daiTrusted') is not None or self.new_object.get(
                'dai_trusted') is not None:
            new_object_params['daiTrusted'] = self.new_object.get('daiTrusted')
        if self.new_object.get('profile') is not None or self.new_object.get(
                'profile') is not None:
            new_object_params['profile'] = self.new_object.get('profile') or \
                self.new_object.get('profile')
        if self.new_object.get('dot3az') is not None or self.new_object.get(
                'dot3az') is not None:
            new_object_params['dot3az'] = self.new_object.get('dot3az') or \
                self.new_object.get('dot3az')
        if self.new_object.get('highSpeed') is not None or self.new_object.get(
                'high_speed') is not None:
            new_object_params['highSpeed'] = self.new_object.get(
                'highSpeed') or self.new_object.get('high_speed')
        if self.new_object.get('serial') is not None or self.new_object.get(
                'serial') is not None:

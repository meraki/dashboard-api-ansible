...
required_if = [
    ("state", "present", ["name", "organizationId", "policyId"], True),
    ("state", "absent", ["name", "organizationId", "policyId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class OrganizationsPoliciesGlobalGroupPolicies(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                ...
                function="getOrganizationPoliciesGlobalGroupPolicies",
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "policy_id") or self.new_object.get("policyId")
        ...
        if name_exists:
            _id = prev_obj.get("id")
            _id = _id or prev_obj.get("policyId")
            if id_exists and name_exists and o_id != _id:
                raise InconsistentParameters(
                    "The 'id' and 'name' params don't refer to the same object")
            if _id:
                self.new_object.update(dict(id=_id))
                self.new_object.update(dict(policyId=_id))
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="organizations",
            function="createOrganizationPoliciesGlobalGroupPolicy",
    ...
    def update(self):
        ...
        id = id or self.new_object.get("policyId")
        name = self.new_object.get("name")
        result = None
        if not id:
            ...
            if prev_obj_name:
                ...
                id_ = id_ or prev_obj_name.get("policyId")
            if id_:
                self.new_object.update(dict(policyId=id_))
        result = self.meraki.exec_meraki(
            family="organizations",
            function="updateOrganizationPoliciesGlobalGroupPolicy",
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="deleteOrganizationPoliciesGlobalGroupPolicy",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsPoliciesGlobalGroupPolicies(self._task.args, meraki)

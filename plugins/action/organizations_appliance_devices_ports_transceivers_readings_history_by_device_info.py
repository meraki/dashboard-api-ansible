...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("serials") is not None:
            new_object["serials"] = params.get(
                "serials")
        if params.get("portIds") is not None:
            new_object["portIds"] = params.get(
                "portIds")
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            family="appliance",
            function='getOrganizationApplianceDevicesPortsTransceiversReadingsHistoryByDevice',
            params=self.get_all(
                self._task.args),
        )

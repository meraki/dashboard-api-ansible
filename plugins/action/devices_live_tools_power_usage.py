...
class DevicesLiveToolsPowerUsage(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="devices",
                function="getDeviceLiveToolsPowerUsage",
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="devices",
            function="createDeviceLiveToolsPowerUsage",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DevicesLiveToolsPowerUsage(self._task.args, meraki)

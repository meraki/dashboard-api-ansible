...
required_if = [
    ("state", "present", ["name", "organizationId", "rulesetId"], True),
    ("state", "absent", ["name", "organizationId", "rulesetId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class OrganizationsPoliciesGlobalFirewallRulesets(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                ...
                function="getOrganizationPoliciesGlobalFirewallRulesets",
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "ruleset_id") or self.new_object.get("rulesetId")
        ...
        if name_exists:
            _id = prev_obj.get("id")
            _id = _id or prev_obj.get("rulesetId")
            if id_exists and name_exists and o_id != _id:
                raise InconsistentParameters(
                    "The 'id' and 'name' params don't refer to the same object")
            if _id:
                self.new_object.update(dict(id=_id))
                self.new_object.update(dict(rulesetId=_id))
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="organizations",
            function="createOrganizationPoliciesGlobalFirewallRuleset",
    ...
    def update(self):
        ...
        id = id or self.new_object.get("rulesetId")
        name = self.new_object.get("name")
        result = None
        if not id:
            ...
            if prev_obj_name:
                ...
                id_ = id_ or prev_obj_name.get("rulesetId")
            if id_:
                self.new_object.update(dict(rulesetId=id_))
        result = self.meraki.exec_meraki(
            family="organizations",
            function="updateOrganizationPoliciesGlobalFirewallRuleset",
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="deleteOrganizationPoliciesGlobalFirewallRuleset",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsPoliciesGlobalFirewallRulesets(

...
class OrganizationsCellularGatewayEsimsInventory(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        if self.new_object.get('eids') is not None or self.new_object.get(
                'eids') is not None:
            new_object_params['eids'] = self.new_object.get('eids')
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="cellulargateway",
            function="updateOrganizationCellularGatewayEsimsInventory",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsCellularGatewayEsimsInventory(

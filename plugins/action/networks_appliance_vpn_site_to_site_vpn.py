...
class NetworksApplianceVpnSiteToSiteVpn(object):
    ...
    def update_all_params(self):
        ...
        if self.new_object.get('hubs') is not None or self.new_object.get(
                'hubs') is not None:
            new_object_params['hubs'] = self.new_object.get('hubs') or \
                self.new_object.get('hubs')
        if self.new_object.get('subnets') is not None or self.new_object.get(
                'subnets') is not None:
        ...
        if self.new_object.get('hostTranslations') is not None or self.new_object.get(
                'host_translations') is not None:
            new_object_params['hostTranslations'] = self.new_object.get(
                'hostTranslations') or self.new_object.get('host_translations')
        if self.new_object.get('networkId') is not None or self.new_object.get(
                'network_id') is not None:
            new_object_params['networkId'] = self.new_object.get(
                'networkId') or self.new_object.get('network_id')

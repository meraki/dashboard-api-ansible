...
argument_spec.update(dict(
    ...
    macTableId=dict(type="str"),
))

required_if = [
    ("state", "present", ["macTableId", "serial"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class DevicesLiveToolsMacTable(object):
    ...
    def get_params_by_id(self, name=None, id=None):
        ...
        if self.new_object.get('macTableId') is not None or self.new_object.get(
                'mac_table_id') is not None:
            new_object_params['macTableId'] = self.new_object.get(
                'macTableId') or self.new_object.get('mac_table_id')
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="devices",
                function="getDeviceLiveToolsMacTable",
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "mac_table_id") or self.new_object.get("macTableId")
        ...
        if name_exists:
            _id = prev_obj.get("id")
            _id = _id or prev_obj.get("macTableId")
            if id_exists and name_exists and o_id != _id:
                raise InconsistentParameters(
                    "The 'id' and 'name' params don't refer to the same object")
            if _id:
                self.new_object.update(dict(id=_id))
                self.new_object.update(dict(macTableId=_id))
            if _id:
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="devices",
            function="createDeviceLiveToolsMacTable",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DevicesLiveToolsMacTable(self._task.args, meraki)

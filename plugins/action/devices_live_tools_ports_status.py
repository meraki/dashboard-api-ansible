...
required_if = [
    ("state", "present", ["jobId", "serial"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class DevicesLiveToolsPortsStatus(object):
    ...
    def get_params_by_id(self, name=None, id=None):
        ...
        if self.new_object.get('jobId') is not None or self.new_object.get(
                'job_id') is not None:
            new_object_params['jobId'] = self.new_object.get('jobId') or \
                self.new_object.get('job_id')
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="devices",
                function="getDeviceLiveToolsPortsStatus",
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "job_id") or self.new_object.get("jobId")
        ...
        if name_exists:
            ...
            if _id:
                ...
                self.new_object.update(dict(jobId=_id))
            if _id:
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="devices",
            function="createDeviceLiveToolsPortsStatus",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DevicesLiveToolsPortsStatus(self._task.args, meraki)

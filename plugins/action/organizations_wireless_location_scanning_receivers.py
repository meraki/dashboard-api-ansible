...
argument_spec.update(dict(
    ...
    radio=dict(type="dict"),
    sharedSecret=dict(type="str"),
    organizationId=dict(type="str"),
    receiverId=dict(type="str"),
))

required_if = [
    ("state", "present", ["organizationId", "receiverId"], True),
    ("state", "absent", ["organizationId", "receiverId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class OrganizationsWirelessLocationScanningReceivers(object):
    ...
    def create_params(self):
        ...
        if self.new_object.get('version') is not None or self.new_object.get(
                'version') is not None:
            new_object_params['version'] = self.new_object.get('version') or \
                self.new_object.get('version')
        if self.new_object.get('radio') is not None or self.new_object.get(
                'radio') is not None:
            new_object_params['radio'] = self.new_object.get('radio') or \
                self.new_object.get('radio')
    ...
    def delete_by_id_params(self):
        ...
        if self.new_object.get('organizationId') is not None or self.new_object.get(
            ...
            new_object_params['organizationId'] = self.new_object.get(
                'organizationId') or self.new_object.get('organization_id')
        if self.new_object.get('receiverId') is not None or self.new_object.get(
                'receiver_id') is not None:
            new_object_params['receiverId'] = self.new_object.get(
                'receiverId') or self.new_object.get('receiver_id')
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="wireless",
                function="getOrganizationWirelessLocationScanningReceivers",
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "receiver_id") or self.new_object.get("receiverId")
        ...
        if name_exists:
            _id = prev_obj.get("id")
            _id = _id or prev_obj.get("receiverId")
            if id_exists and name_exists and o_id != _id:
                raise InconsistentParameters(
                    "The 'id' and 'name' params don't refer to the same object")
            if _id:
                self.new_object.update(dict(id=_id))
                self.new_object.update(dict(receiverId=_id))
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="wireless",
            function="createOrganizationWirelessLocationScanningReceiver",
    ...
    def update(self):
        ...
        id = id or self.new_object.get("receiverId")
        name = self.new_object.get("name")
        result = None
        if not id:
            ...
            if prev_obj_name:
                ...
                id_ = id_ or prev_obj_name.get("receiverId")
            if id_:
                self.new_object.update(dict(receiverId=id_))
        result = self.meraki.exec_meraki(
            family="wireless",
            function="updateOrganizationWirelessLocationScanningReceiver",
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="wireless",
            function="deleteOrganizationWirelessLocationScanningReceiver",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsWirelessLocationScanningReceivers(

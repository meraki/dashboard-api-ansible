    ...
    def update_all_params(self):
        ...
        if self.new_object.get('rstpEnabled') is not None or self.new_object.get(
            ...
            new_object_params['rstpEnabled'] = self.new_object.get(
                'rstpEnabled')
        if self.new_object.get('stpBridgePriority') is not None or self.new_object.get(
                'stp_bridge_priority') is not None:
            new_object_params['stpBridgePriority'] = self.new_object.get(
                'stpBridgePriority') or self.new_object.get('stp_bridge_priority')
        if self.new_object.get('networkId') is not None or self.new_object.get(
                'network_id') is not None:
            new_object_params['networkId'] = self.new_object.get(
                'networkId') or self.new_object.get('network_id')

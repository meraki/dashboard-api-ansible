...
class NetworksClientsPolicy(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        if self.new_object.get('devicePolicy') is not None or self.new_object.get(
                'device_policy') is not None:
            new_object_params['devicePolicy'] = self.new_object.get(
                'devicePolicy') or self.new_object.get('device_policy')

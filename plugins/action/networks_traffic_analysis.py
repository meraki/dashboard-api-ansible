...
class NetworksTrafficAnalysis(object):
    ...
    def update_all_params(self):
        ...
        if self.new_object.get('customPieChartItems') is not None or self.new_object.get(
                'custom_pie_chart_items') is not None:
            new_object_params['customPieChartItems'] = self.new_object.get(
                'customPieChartItems') or self.new_object.get('custom_pie_chart_items')
        if self.new_object.get('networkId') is not None or self.new_object.get(
                'network_id') is not None:
            new_object_params['networkId'] = self.new_object.get(
                'networkId') or self.new_object.get('network_id')

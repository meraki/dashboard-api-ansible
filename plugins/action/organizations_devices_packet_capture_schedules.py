...
required_if = [
    ("state", "present", ["name", "organizationId", "scheduleId"], True),
    ("state", "absent", ["name", "organizationId", "scheduleId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class OrganizationsDevicesPacketCaptureSchedules(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        if self.new_object.get('scheduleIds') is not None or self.new_object.get(
                'schedule_ids') is not None:
            new_object_params['scheduleIds'] = self.new_object.get(
                'scheduleIds') or self.new_object.get('schedule_ids')
        ...
        if self.new_object.get('deviceIds') is not None or self.new_object.get(
                'device_ids') is not None:
            new_object_params['deviceIds'] = self.new_object.get(
                'deviceIds') or self.new_object.get('device_ids')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                ...
                function="getOrganizationDevicesPacketCaptureSchedules",
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "schedule_id") or self.new_object.get("scheduleId")
        ...
        if name_exists:
            _id = prev_obj.get("id")
            _id = _id or prev_obj.get("scheduleId")
            if id_exists and name_exists and o_id != _id:
                raise InconsistentParameters(
                    "The 'id' and 'name' params don't refer to the same object")
            if _id:
                self.new_object.update(dict(id=_id))
                self.new_object.update(dict(scheduleId=_id))
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="organizations",
            function="createOrganizationDevicesPacketCaptureSchedule",
    ...
    def update(self):
        ...
        id = id or self.new_object.get("scheduleId")
        name = self.new_object.get("name")
        result = None
        if not id:
            ...
            if prev_obj_name:
                ...
                id_ = id_ or prev_obj_name.get("scheduleId")
            if id_:
                self.new_object.update(dict(scheduleId=id_))
        result = self.meraki.exec_meraki(
            family="organizations",
            function="updateOrganizationDevicesPacketCaptureSchedule",
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="deleteOrganizationDevicesPacketCaptureSchedule",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsDevicesPacketCaptureSchedules(

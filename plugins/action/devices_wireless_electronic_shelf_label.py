...
class DevicesWirelessElectronicShelfLabel(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        if self.new_object.get('channel') is not None or self.new_object.get('channel') is not None:
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="wireless",
            function="updateDeviceWirelessElectronicShelfLabel",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DevicesWirelessElectronicShelfLabel(self._task.args, meraki)

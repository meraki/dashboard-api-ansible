...
argument_spec.update(dict(
    ...
    includeUndetectedClients=dict(type="bool"),
...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("timespan") is not None:
            new_object["timespan"] = params.get(
                "timespan")
        if params.get("includeUndetectedClients") is not None:
            new_object["includeUndetectedClients"] = params.get(
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            ...
            function='getOrganizationPoliciesAssignmentsByClient',

...
argument_spec.update(dict(
    ...
    captureIds=dict(type="list"),
    networkIds=dict(type="list"),
    serials=dict(type="list"),
    process=dict(type="list"),
    captureStatus=dict(type="list"),
    name=dict(type="list"),
    clientMac=dict(type="list"),
    notes=dict(type="str"),
    ...
    def get_all(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("captureIds") is not None:
            new_object["captureIds"] = params.get(
                "captureIds")
        ...
        if params.get("process") is not None:
            new_object["process"] = params.get(
                "process")
        if params.get("captureStatus") is not None:
            new_object["captureStatus"] = params.get(
                "captureStatus")
        ...
        if params.get("notes") is not None:
            new_object["notes"] = params.get(
                "notes")
        if params.get("deviceName") is not None:
            new_object["deviceName"] = params.get(
                "deviceName")
        if params.get("adminName") is not None:
            new_object["adminName"] = params.get(
                "adminName")

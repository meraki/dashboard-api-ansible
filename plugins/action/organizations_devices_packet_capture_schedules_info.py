    ...
    def get_all(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("scheduleIds") is not None:
            new_object["scheduleIds"] = params.get(
                "scheduleIds")
        if params.get("networkIds") is not None:
            new_object["networkIds"] = params.get(
                "networkIds")
        if params.get("deviceIds") is not None:
            new_object["deviceIds"] = params.get(
                "deviceIds")

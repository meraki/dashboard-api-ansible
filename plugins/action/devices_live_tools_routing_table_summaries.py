...
class DevicesLiveToolsRoutingTableSummaries(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="devices",
                function="getDeviceLiveToolsRoutingTableSummary",
                params={"id": id}
            )
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="devices",
            function="createDeviceLiveToolsRoutingTableSummary",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DevicesLiveToolsRoutingTableSummaries(self._task.args, meraki)

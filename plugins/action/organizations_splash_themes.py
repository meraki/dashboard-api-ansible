...
class OrganizationsSplashThemes(object):
    ...
    def create_params(self):
        ...
        if self.new_object.get('baseTheme') is not None or self.new_object.get(
                'base_theme') is not None:
            new_object_params['baseTheme'] = self.new_object.get(
                'baseTheme') or self.new_object.get('base_theme')
        if self.new_object.get('organizationId') is not None or self.new_object.get(
                'organization_id') is not None:
            new_object_params['organizationId'] = self.new_object.get(
                'organizationId') or self.new_object.get('organization_id')

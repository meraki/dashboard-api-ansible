...
class OrganizationsSplashThemes(object):
    ...
    def create_params(self):
        new_object_params = {}
        if self.new_object.get('baseTheme') is not None or self.new_object.get('base_theme') is not None:
            new_object_params['baseTheme'] = self.new_object.get('baseTheme') or \
                self.new_object.get('base_theme')
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="organizations",
            function="createOrganizationSplashTheme",
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="deleteOrganizationSplashTheme",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsSplashThemes(self._task.args, meraki)

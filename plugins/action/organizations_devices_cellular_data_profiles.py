...
class OrganizationsDevicesCellularDataProfiles(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                ...
                function="getOrganizationDevicesCellularDataProfiles",
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="organizations",
            function="createOrganizationDevicesCellularDataProfile",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="updateOrganizationDevicesCellularDataProfile",
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="deleteOrganizationDevicesCellularDataProfile",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsDevicesCellularDataProfiles(self._task.args, meraki)

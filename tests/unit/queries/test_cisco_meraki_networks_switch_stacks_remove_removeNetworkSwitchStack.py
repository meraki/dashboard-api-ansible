"""
Test for cisco.meraki.networks_switch_stacks_remove using fixture cisco.meraki.networks_switch_stacks_remove.json
...
def test_cisco_meraki_networks_switch_stacks_remove_removeNetworkSwitchStack(
    query_data, load_fixture
):
    """Test query execution for cisco.meraki.networks_switch_stacks_remove (removeNetworkSwitchStack)."""
    module_fqcn = "cisco.meraki.networks_switch_stacks_remove"
    method_name = "removeNetworkSwitchStack"

"""
Test for cisco.meraki.networks_switch_routing_multicast_info using fixture cisco.meraki.networks_switch_routing_multicast_info.json
...
def test_cisco_meraki_networks_switch_routing_multicast_info_getNetworkSwitchRoutingMulticast(
    query_data, load_fixture
):
    """Test query execution for cisco.meraki.networks_switch_routing_multicast_info (getNetworkSwitchRoutingMulticast)."""
    module_fqcn = "cisco.meraki.networks_switch_routing_multicast_info"
    method_name = "getNetworkSwitchRoutingMulticast"

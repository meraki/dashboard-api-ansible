"""
Test for cisco.meraki.networks_switch_settings_info using fixture cisco.meraki.networks_switch_settings_info.json
...
def test_cisco_meraki_networks_switch_settings_info_getNetworkSwitchSettings(
    query_data, load_fixture
):
    """Test query execution for cisco.meraki.networks_switch_settings_info (getNetworkSwitchSettings)."""
    module_fqcn = "cisco.meraki.networks_switch_settings_info"
    method_name = "getNetworkSwitchSettings"

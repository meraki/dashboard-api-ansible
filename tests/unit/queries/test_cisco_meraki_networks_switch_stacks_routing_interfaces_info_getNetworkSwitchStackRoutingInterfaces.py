"""
Test for cisco.meraki.networks_switch_stacks_routing_interfaces_info using fixture cisco.meraki.networks_switch_stacks_routing_interfaces_info.json
...
def test_cisco_meraki_networks_switch_stacks_routing_interfaces_info_getNetworkSwitchStackRoutingInterfaces(
    ...
    """Test query execution for cisco.meraki.networks_switch_stacks_routing_interfaces_info (getNetworkSwitchStackRoutingInterfaces)."""
    module_fqcn = "cisco.meraki.networks_switch_stacks_routing_interfaces_info"
    method_name = "getNetworkSwitchStackRoutingInterfaces"

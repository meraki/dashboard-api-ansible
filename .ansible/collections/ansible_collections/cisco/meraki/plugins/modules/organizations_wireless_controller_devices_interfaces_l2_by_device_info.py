...
notes:
  - SDK Method used are wireless_controller.WirelessController.get_organization_wireless_controller_devices_interfaces_l2_by_device,
  - Paths used are get /organizations/{organizationId}/wirelessController/devices/interfaces/l2/byDevice,
options:
  endingBefore:
    description:
...
requirements:
  ...
  - python >= 3.5
seealso:
  - description: Complete reference of the getOrganizationWirelessControllerDevicesInterfacesL2ByDevice
      API.

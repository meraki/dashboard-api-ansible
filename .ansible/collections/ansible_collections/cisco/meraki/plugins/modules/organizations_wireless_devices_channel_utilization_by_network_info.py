...
notes:
  - SDK Method used are wireless.Wireless.get_organization_wireless_devices_channel_utilization_by_network,
  - Paths used are get /organizations/{organizationId}/wireless/devices/channelUtilization/byNetwork,
options:
  endingBefore:
    description:
...
requirements:
  ...
  - python >= 3.5
seealso:
  - description: Complete reference of the getOrganizationWirelessDevicesChannelUtilizationByNetwork
      API.
...
short_description: Information module for organizations _wireless _devices _channel
  _utilization _by _network
version_added: 2.16.0
"""

EXAMPLES = r"""
- name: Get all organizations _wireless _devices _channel _utilization _by _network

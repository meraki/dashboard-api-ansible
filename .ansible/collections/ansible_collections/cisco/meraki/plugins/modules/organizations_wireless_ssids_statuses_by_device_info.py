...
notes:
  - SDK Method used are wireless.Wireless.get_organization_wireless_ssids_statuses_by_device,
  - Paths used are get /organizations/{organizationId}/wireless/ssids/statuses/byDevice,
options:
  bssids:
    description:

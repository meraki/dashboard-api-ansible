...
notes:
  - SDK Method used are wireless.Wireless.get_organization_wireless_devices_wireless_controllers_by_device,
  - Paths used are get /organizations/{organizationId}/wireless/devices/wirelessControllers/byDevice,
options:
  controllerSerials:
    description:

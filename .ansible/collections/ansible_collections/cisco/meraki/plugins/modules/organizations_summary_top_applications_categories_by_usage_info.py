...
EXAMPLES = r"""
- name: Get all organizations _summary _top _applications _categories _by _usage
  cisco.meraki.organizations_summary_top_applications_categories_by_usage_info:

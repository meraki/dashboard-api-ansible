...
notes:
  - SDK Method used are appliance.Appliance.get_organization_appliance_uplinks_usage_by_network,
  - Paths used are get /organizations/{organizationId}/appliance/uplinks/usage/byNetwork,
options:
  headers:
  ...
  timespan:
    description:
      - 'Timespan query parameter. The timespan for which the information will be
        ...
        value must be in seconds and be less than or equal to 14 days. The default
        is 1 day.

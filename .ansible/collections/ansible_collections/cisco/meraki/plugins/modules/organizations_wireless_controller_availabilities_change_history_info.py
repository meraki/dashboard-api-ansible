...
description:
  ...
  - 'List connectivity data of wireless LAN controllers in an organization. If it
    is HA setup, then only returns active WLC data start from switchover.
...
notes:
  - SDK Method used are wireless_controller.WirelessController.get_organization_wireless_controller_availabilities_change_history,
  - Paths used are get /organizations/{organizationId}/wirelessController/availabilities/changeHistory,
options:
  endingBefore:
    description:
